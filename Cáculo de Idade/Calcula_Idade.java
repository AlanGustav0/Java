    ...
    static void VerificarMostrarDatas()
    {
        ...
        if(diaNasc < diaAtual && mesNasc < mesAtual && anoNasc < anoAtual  )
        {
            if(diaAtual - diaNasc == 1 && mesAtual - mesNasc == 1)
            {
                ...
                JOptionPane.showMessageDialog(null,"Você tem: " + anoTotal + " anos " + mesTotal + " mes " + " e " + diaTotal + " dia de vida.");
            }
            else
            {
                diaTotal = CalculaDias(diaNasc,contadorDias);
                ...
                JOptionPane.showMessageDialog(null,"Você tem: " + anoTotal + " anos " + mesTotal + " meses " + " e " + diaTotal + " dias de vida.");
        ...
        else if(diaNasc == diaAtual && mesNasc == mesAtual && anoNasc < anoAtual)
        {
            ...
            else
            {
                ...
                JOptionPane.showMessageDialog(null,"Você tem: " + anoTotal + " anos " + mesTotal + " meses " + diaTotal + " dias de vida."); 
        ...
        else if(diaNasc == diaAtual && mesNasc < mesAtual && anoNasc < anoAtual)
        {
            ...
            JOptionPane.showMessageDialog(null,"Você tem: " + anoTotal + " anos " + "e " + mesAtual + " meses de vida.");
        }
        ...
        else if(diaNasc < diaAtual && mesNasc == mesAtual && anoNasc < anoAtual)
        {
            ...
            JOptionPane.showMessageDialog(null,"Você tem: " + anoTotal + " anos " + mesAtual + " meses e " + diaAtual + " dias de vida.");
        }
        ...
        else if(diaNasc < diaAtual && mesNasc <= mesAtual && anoNasc == anoAtual)
        {
            ...
            JOptionPane.showMessageDialog(null,"Você tem: " + mesTotal + " meses " + " e " + diaTotal + " dias de vida.");
        }
        ...
        //* CONDIÇÕES COM DIAS E MESES DE NASCIMENTO MAIOR QUE ATUAL (>) - ANO DE NASCIMENTO MENOR (<) OU (=)
        ...
        else if(diaNasc > diaAtual && mesNasc < mesAtual && anoNasc < anoAtual)
        {
            ...
            if(contadorDias == 1)
            {
                ...
                JOptionPane.showMessageDialog(null, "Você tem: " + anoTotal + " anos " + mesTotal + " meses e " + diaTotal + " dia de vida.");
        ...
        else if(diaNasc > diaAtual && mesNasc < mesAtual && anoNasc == anoAtual)
        {
            ...
            {
              JOptionPane.showMessageDialog(null,"Você tem: " + mesTotal + " mes " + " e "+ diaTotal + " dia de vida."); 
            }
            else
            {
              JOptionPane.showMessageDialog(null,"Você tem: " + mesTotal + " meses " + " e " + diaTotal + " dias de vida.");   
